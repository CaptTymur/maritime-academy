(() => {
    ...
    description.content = `Действующая реестровая запись сертификата ${certificateId}, выданного ${record.holder} Мореходными классами.`;
            ...
            <div class="verification-layout">
                ...
                <aside class="side-stack" aria-label="Реестровые данные">
                    ...
                    <section class="registry-card">
                        ...
                        <p>Запись опубликована 19 июля 2026 года.</p>
                    </section>
